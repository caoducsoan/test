		...
		<tr class="<?php echo $stt%2 ? 'odd' : 'even'; ?>">
			...
			<?php 
				if($item->parent!=0)
				{
					...
					$chuyenmuc=$this->db->get('tbl_chuyenmuc')->row();					
					echo $chuyenmuc->name;            
				}
				else{
					echo '-';
			...
			<td align="center">						
			  ...
			  {
			  ?>
			  <a class="status" onclick="check_status(<?php echo $item->id; ?>,'tbl_chuyenmuc','chuyenmuc')"><img src="images/toolbar/tick.png"></a>
			  <?php
			  }
			  else
			  {
			  ?>
			  <a class="status" onclick="check_status(<?php echo $item->id; ?>,'tbl_chuyenmuc','chuyenmuc')"><img src="images/toolbar/publish_x.png"></a>
			  <?php
			  }
			  ?>			
			</td>       
