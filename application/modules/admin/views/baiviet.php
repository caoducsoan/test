    ...
    ?>
		<tr class="<?php echo $stt%2 ? 'odd' : 'even'; ?>">
			...
			<td align="center">						
			  ...
			  ?>
			  <a class="status" onclick="check_status(<?php echo $item->id; ?>,'tbl_baiviet','baiviet')"><img src="images/toolbar/publish_y.png"></a>
			  <?php
			  }else{
			  ?>
			  <a class="status" onclick="check_status(<?php echo $item->id; ?>,'tbl_baiviet','baiviet')"><img src="images/toolbar/tick.png"></a>
			  <?php }
			  }
			  else
			  {
			  ?>
			  <a class="status" onclick="check_status(<?php echo $item->id; ?>,'tbl_baiviet','baiviet')"><img src="images/toolbar/publish_x.png"></a>
			  <?php
			  }
			  ?>
			</td>    			
			<td><?php 
					$cats=$CI->admin_model->gettbl('tbl_chuyenmuc',$item->cid);
					if($cats->num_rows()> 0){
					$cat= $cats->row();
						echo $cat->name;
					}
