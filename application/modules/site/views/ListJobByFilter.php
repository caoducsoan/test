...
<section class="search-result">
      <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo $textcrum; ?></li>
        </ol>
              ...
              <div class="filter-list citylist">
                ...
                <ul>
                    ...
                    if(!empty($category)){
                        ...
                        {
                            if($checkcat==$itemcat['cat_id']){
                            ?>  
                              <li>
                                <input checked="checked" onclick="load('<?php echo $itemcat['url']  ?>')" name="jobnn<?php echo $itemcat['cat_id']  ?>" id="jobnn<?php echo $itemcat['cat_id']  ?>" type="checkbox">
                                <label for="jobnn<?php echo $itemcat['cat_id']  ?>"><?php echo $itemcat['cat_name']  ?></label>
                                <span class="pull-right"><?php echo $itemcat['tongbanghi']  ?></span>
                              </li>
                           <?php }else{
                            ?>
                            <li>
                                <input onclick="load('<?php echo $itemcat['url']  ?>')" name="jobnn<?php echo $itemcat['cat_id']  ?>" id="jobnn<?php echo $itemcat['cat_id']  ?>" type="checkbox">
                                <label for="jobnn<?php echo $itemcat['cat_id']  ?>"><?php echo $itemcat['cat_name']  ?></label>
                                <span class="pull-right"><?php echo $itemcat['tongbanghi']  ?></span>
                              </li>
                   <?php  }   }
...
$('#index_nganhnghe').select2({ width: 'calc(100% - 7px)' }).select2("val", "<?php echo $checkcat ?>");
$('#index_dia_diem').select2({ width: 'calc(100% - 7px)' }).select2("val", "<?php echo $checkpro ?>");
