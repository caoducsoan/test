        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#candidate" aria-controls="candidate" role="tab" data-toggle="tab" aria-expanded="true">Tài khoản ứng viên <span>Tìm công việc phù hợp</span></a></li>
              <li role="presentation" class=""><a href="#employer" aria-controls="employer" role="tab" data-toggle="tab" aria-expanded="false">Tài khoản nhà tuyển dụng <span>Tìm ứng viên giỏi</span></a></li>
            </ul>
            <!-- Tab panes -->
              ...
              <div role="tabpanel" class="tab-pane" id="employer">
                <div class="signin-form">
                  <h6>Các trường có * là bắt buộc</h6>
                    ...
                    <div class="row">
                      <div class="col-md-8 col-md-offset-2 text-center">
                        <div class="form-group checkbox checkboxcom">
