 ...
 Sinh học</option> 
        ...
        <div class="position-intro">
          <div class="row">
            ...
            <div class="col-md-2">
              <a href="<?php echo base_url()."".vn_str_filter($itemcom->usc_company)."-ntd".$itemcom->usc_id.".html"; ?>"><img src="<?= gethumbnail(geturlimageAvatar($itemcom->usc_create_time).$itemcom->usc_logo,$itemcom->usc_logo,$itemcom->usc_create_time,155,155,95) ?>" onerror='this.onerror=null;this.src="images/no-image.png";' alt="<?php echo $n->usc_company ?>"></a>
            </div>
            <div class="col-md-10">
              <div class="company-info note-intro">
                <h1><?php echo $itemcom->usc_company; ?></h1>
                <p><i class="fa fa-map-marker"></i> <strong>Địa chỉ:</strong> <?php echo $itemcom->usc_address ?></p>
                <p><i class="fa fa-users"></i> <strong>Quy mô công ty:</strong> <?php echo GetQuyMoCty($itemcom->usc_size); ?></p>
                <p><i class="fa fa-internet-explorer"></i> <strong>Website:</strong>  <?php echo $itemcom->usc_website ?></p>
...
<p><i class="fa fa-fax"></i> <strong>Fax:</strong> Chưa cập nhật</p>
<p><i class="fa fa-at"></i> <strong>Email:</strong> <?php if(empty($itemcom->usc_email)){echo "Chưa cập nhật";}else{ echo $itemcom->usc_email;} ?></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <div class="similar-jobs-section job-list">
              <h5>Công ty đang tuyển
                <?php if(count($morejob)== 6){ ?> 
              <a href="javascript:void(0);" class="pull-right">Xem tất cả</a>
              <?php } ?>
              </h5>
              <div class="row">
                <?php
                              ...
                              <div class="job-icons">
                                ...
                                <span><i class="fa fa-map-marker"></i> <?php echo Getcitybyindex($n->new_city) ?></span>
                                 <?php if($n->new_hinh_thuc > 0 && $n->new_hinh_thuc < 3){ ?>
                                  ...
                                  <?php }else if(intval($n->new_hinh_thuc)==0 ){ ?>
                                    <span class="freelance-time"><?php echo "Chưa cập nhật"; ?></span>
                                  <?php }else{ ?>
